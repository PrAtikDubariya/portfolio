...
function AppContextProvider({ children }) {
    ...
    const content = [

        {
            ...
            content: (<div>
                <img src={`${process.env.PUBLIC_URL}/VotingPortal.jpeg`} alt="VotingPortal" />
            </div>),
        },
        {
            ...
            content:(<div>
                <img src={`${process.env.PUBLIC_URL}/Dinora.jpeg`} alt="DinoraCeramicIndustry"/>
            </div>),
        },
        {
            title: "Portfolio",
            ...
            content: (<div>
                <img src={`${process.env.PUBLIC_URL}/PortFolio.jpeg`} alt="PortFolio" />
            </div>),
        },
    ]
